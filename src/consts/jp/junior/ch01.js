  ...
  lesson: [
    {
      ...
      utilization: {
        ...
        content: [
          [
            '<李,り>：JC企画の小野さんですか。',
            '<小野,おの>：はい、小野です。李秀麗さんですか。',
            '<李,り>：はい、李秀麗です。はじめまして。どうぞよろしくお願いします。',
            '<小野,おの>：はじめまして、小野緑です。'
          ],
          [
            '<森,もり>：李さん、こんにちは。',
            '<李,り>：吉田さんですか。',
            '<森,もり>：いいえ、わたしは吉田じゃありません。森です。',
            '<李,り>：あっ、森さんですか。どうもすみません。',
            '<森,もり>：いいえ。どうぞよろしく。',
            '<李,り>：李秀麗です。こちらこそ、よろしくお願いします。'
          ]
        ]
      },
      grammar: {
    ...
    },
    {
      ...
      utilization: {
        ...
        content: [
          [
            '<小野,おの>：ここはコンビニです。隣は喫茶店です。',
            '<李,り>：あの建物はホテルですか、マンションですか。',
            '<小野,おの>：あそこはマンションです。',
            '<李,り>：あの建物は何ですか。',
            '<小野,おの>：あそこもマンションです。',
            '<李,り>：マンションの隣は？',
          ...
          ['<李,り>：本屋はどこですか。', '<小野,おの>：そこです。そのビルの2階です。'],
          [
            '<李,り>：あのう、東京の地図はどこですか。',
            '<店員,てんいん>：地図ですか。そちらです。'
          ],
          ['<李,り>：いくらですか。', '<店員,てんいん>：500円です。']
        ]
      },
      grammar: {},
      word: [
    ...
    },
    {
      ...
      basic: {
        ...
        use: [
          ['甲：その箱の中に何がありますか。', '乙：時計と眼鏡があります。'],
          ['甲：部屋にだれがいますか。', '乙：だれもいません。'],
          ['甲：小野さんの家はどこにありますか。', '乙：横浜にあります。'],
          ['甲：あそこに犬がいますね。', '乙：ええ、わたしの犬です。']
        ]
      },
      utilization: {
        ...
        content: [
          [
            '<李,り>：小野さん、会社はどこにありますか。',
            '<小野,おの>：ええと、ここです。',
            '<李,り>：近くに駅がありますか。',
            '<小野,おの>：ええ。JRと地下鉄の駅があります。JRの駅はここです。'
          ],
          [
            '<李,り>：地下鉄の駅はここですね。',
            '<小野,おの>：ええ、そうです。JRの駅の隣に地下鉄の駅があります。'
          ],
          [
            '<李,り>：小野さんの家はどちらですか。',
            '<小野,おの>：わたしの家は横浜です。',
            '<李,り>：ご家族も横浜ですか。',
            '<小野,おの>：いいえ、わたしは一人暮らしです。',
            '<李,り>：ご両親はどちらですか。',
            '<小野,おの>：両親は名古屋にいます。',
            '<李,り>：ご兄弟は？',
            '<小野,おの>：大阪に妹がいます。'
