export default {
  ...
  '5-2': {
    content: [
      ...
      '本过程的主要作用:1提高实现质量目标的可能性;2识别无效过程和导致质量低劣的原因;3使用控制质量过程的数据和结果向干系人展示项目的总体质量状态。',
      '需要在整个项目期间开展。'
    ],
  },
  '5-2-1': {
  ...
  '5-3': {
    content: [
      ...
      '本过程的主要作用:①核实项目可交付成果和工作已经达到主要干系人的质量要求，可供最终验收;②确定项目输出是否达到预期目的，这些输出需要满足所有适用标准、要求、法规和规范。',
      '需要在整个项目期间开展。'
    ],
  },
  '5-3-1': {
