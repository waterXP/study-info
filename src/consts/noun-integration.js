export default {
  '1-1': {
    content: [
      ...
      '本过程的主要作用：1）明确项目与组织战略目标之间的直接联系；2）确立项目的正式地位；3）展示组织对项目的承诺。',
      '仅开展一次或仅在项目的预定义时开展。'
    ]
  },
  '1-1-1': {
  ...
  '1-4': {
    content: [
      ...
      '管理项目过程的主要作用:1)利用已有的组织知识来创造或改进项目成果;2)使当前项目创造的知识可用于支持组织运营和未来的项目或阶段。',
      '需要在整个项目期间开展。'
    ],
  },
  '1-4-1': {
  ...
  '1-5': {
    content: [
      ...
      '本过程的主要作用:1)让干系人了解项目的当前状态并认可为处理绩效问题而采取的行动;2)通过成本和进度预测，让干系人了解项目的未来状态。',
      '需要在整个项目期间开展。'
    ],
  },
  '1-5-1': {
  ...
  '1-7': {
    content: [
      ...
      '本过程的主要作用:1)存档项目或阶段信息，完成计划的工作;2)释放组织团队资源以展开新的工作。',
      '仅开展一次或在项目或阶段的结束点开展。'
    ],
  },
  '1-7-1': {
