export default {
  ...
  '7-1-8': {
    content: [
      '用于在项目干系人之间传递信息的方法很多，信息交换和协作的常见方法包括对话、会议、书面文件、数据库、社交媒体和网站。影响沟通技术的选择的因素包括:',
  ...
  '7-1-11': {
    content: [
      ...
      '(1)沟通风格评估。规划沟通活动时，用于评估沟通风格并识别偏好的沟通方法、形式和内容的一种技术。常用于不支持项目的干系人。可以先开展干系人参与度评估，再开展沟通风格评估。在干系人参与度评估中，找出干系人参与度的差距。为弥补这种差距，就需要特别裁剪沟通活动和方法。',
  ...
  '7-2-4': {
    content: [
      '会影响管理沟通过程的事业环境因素主要包括:组织文化和治理框架;人事管理政策;干系人风险临界值;已确立的沟通渠道、工具和系统;全球、区域或当地的发展趋势、最佳实践或文化习俗等;设施和资源的物理分布等。'
    ],
  },
  '7-2-5': {
    content: [
