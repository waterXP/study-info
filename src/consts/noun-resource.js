export default {
  ...
  '6-1-7': {
    content: [
      ...
      '(2)矩阵型:展示项目资源在各个工作包中的任务分配。矩阵型图表的一个例子是职责分配矩阵(RAM)，它显示了分配给每个工作包的项目资源，用于说明工作包或活动与项目团队成员之间的关系。在大型项目中，可以制定多个层次的RAM，例如，高层次的RAM可定义项目团队、小组或部门负责WBS中的哪部分工作，而低层次的RAM则可在各小组内为具体活动分配角色、职责和职权。矩阵型图表能反映与每个人相关的所有活动，以及与每项活动相关的所有人员，它也可确保任何一项任务都只有一个人负责，从而避免职权不清',
  ...
  '6-2-8': {
    content: [
      '参数估算基于历史数据和项目参数，使用某种算法或历史数据与其他变量之间的统计关系，来计算活动所需的资源数量。例如，一项活动需要4000小时的编码时间，1年之内完成，则需要2人编码(每人每年付出2000小时)。参数估算的准确性取决于参数模型的成熟度和基础数据的可靠性。'
    ],
  },
  '6-2-9': {
    content: [
  ...
  '6-3': {
    content: [
      '获取资源是获取项目所需的团队成员、设施、设备、材料、用品和其他资源的过程。本过程的主要作用:①概述和指导资源的选择;②将选择的资源分配给相应的活动。'
    ],
  },
  '6-3-1': {
    content: [
  ...
  '6-3-6': {
    content: [
      '适用于获取资源过程的人际关系与团队技能是谈判。很多项目需要针对所需资源进行谈判。',
      '项目管理团队需要与下列各方谈判:',
  ...
  '6-4-13': {
    content: [
      ...
      '评价团队有效性的指标可包括:①个人技能的改进，使成员更有效地完成工作任务;②团队能力的改进，从而使团队成员更好地开展工作;③团队成员离职率的降低;④团队凝聚力的加强，从而使团队成员公开分享信息和经验，并互相帮助来提高项目绩效。通过对团队整体绩效的评价，项目管理团队能够识别出所需的特殊培训、教练、辅导、协助或改变，以提高团队绩效。项目管理团队也应该识别出合适或所需的资源，以执行和实现在绩效评价过程中提出的改进建议。'
    ],
    important: true
  },
  '6-4-14': {
  ...
  '6-6': {
    content: [
      '控制资源是确保按计划为项目分配实物资源，以及根据资源使用计划监督资源实际使用情况，并采取必要纠正措施的过程。本过程的主要作用:①确保所分配的资源适时、适地可用于项目;②资源在不再需要时被释放。'
    ],
  },
  '6-6-1': {
    content: [
