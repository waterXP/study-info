  ...
  lesson: [
    ...
    },
    {
      ...
      utilization: {
        ...
        content: [
          ...
          ['<李,り>：<本屋,ほんや>はどこですか。', '<小野,おの>：そこです。そのビルの2<階,かい>です。'],
          [
            '<李,り>：あのう、<東京,とうきょう>の<地図,ちず>はどこですか。',
            '<店員,てんいん>：<地図,ちず>ですか。そちらです。'
          ],
          ['<李,り>：いくらですか。', '<店員,てんいん>：<500,ごひゃく><円,えん>です。']
        ]
      },
      grammar: {},
      word: [
    ...
    },
    {
      ...
      basic: {
        ...
        use: [
          ['<甲,こう>：その<箱,はこ>の<中,なか>に<何,なに>がありますか。', '<乙,おつ>：<時計,とけい>と<眼鏡,めがね>があります。'],
          ['<甲,こう>：<部屋,へや>にだれがいますか。', '<乙,おつ>：だれもいません。'],
          ['<甲,こう>：<小野,おの>さんの<家,いえ>はどこにありますか。', '<乙,おつ>：<横浜,よこはま>にあります。'],
          ['<甲,こう>：あそこに<犬,いぬ>がいますね。', '<乙,おつ>：ええ、わたしの<犬,いぬ>です。']
        ]
      },
      utilization: {
