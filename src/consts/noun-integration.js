export default {
  ...
  '1-1-5': {
    content: [
      '是指基于某应用领域、知识领域、学科和行业等的专业知识而做出的、关于当前活动的合理判断，这些专业知识可来自具有专业学历、知识、技能、经验或培训经历的任何小组或个人。制定项目章程过程中，应征求具备如下领域相关专业知识或接受过相关培训的个人或小组的意见，涉及领域包括：组织战略；效益管理；项目所任的行业以及项目关注的领域的技术知识；持续时间和预算的估算；风险识别等领域。'
    ]
  },
  '1-1-6': {
    content: [
